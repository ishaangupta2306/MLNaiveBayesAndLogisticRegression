# CSDS 440 Group 5 Programming Assignment 2
...
# CSDS 440 Group 5 Programming Assignment 1

This repository contains group 5's submission for programming assignment 1.
...
In hindsight, we recognize that it would have been very useful to design our decision tree to return predictions as confidence values equal to the ratio of positive class labels partitioned at a leaf node rather than to only return the majority class label. Having confidence values would have allowed us to generate ROC curves and better evaluate our algorithm on different dataset and with different modifications in our research extension.
...
2. Once python is installed, install poetry (see docs here: https://python-poetry.org/docs/master/#installation)
